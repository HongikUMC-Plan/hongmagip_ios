...
func getRestaurantLink(for restaurant:String, platform: String) -> URL? {
    ...
    // Return the corresponding link based on the restaurant's name and the specified platform
    ...
    case ("금복식당", "kakao"):
        return URL(string: "http://kko.to/5kO4NTmFpQ")
    case ("후계동", "naver"):
    ...
    case ("꼬이", "naver"):
        return URL(string: "https://naver.me/GAi635xC")
    case ("꼬이", "kakao"):
        return URL(string: "https://place.map.kakao.com/969025722")
    case ("미분당", "naver"):
    ...
    case ("테이스티버거", "naver"):
        return URL(string: "https://naver.me/xv0Lj0iy")
    case ("테이스티버거", "kakao"):
        return URL(string: "https://place.map.kakao.com/1737612851")
    case ("맘스터치", "naver"):
    ...
    case ("오늘타코", "naver"):
        return URL(string: "https://naver.me/IG6cR415")
    case ("오늘타코", "kakao"):
    ...
    case ("무궁화타운", "naver"):
        return URL(string: "https://naver.me/5jY81Wgg")
    case ("무궁화타운", "kakao"):
        return URL(string: "https://place.map.kakao.com/2028048009")
